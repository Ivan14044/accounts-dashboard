...
<head>
    ...
    <style>
        ...
        /* Планшет и телефон боком (768–991px): колонка «Найти / Сбросить»
           шириной col-md-1 (~60px) не вмещала две кнопки, и «Сбросить» вылезал
           за край страницы (7px до правок; с кнопками 44px под палец — 23px).
           Даём колонке ширину по содержимому — в строке фильтров на это есть
           место (занято 11 из 12 долей). На ≥992px правило не действует. */
        @media (min-width: 768px) and (max-width: 991.98px) {
            .filters-card form > .col-md-1 { flex: 0 0 auto; width: auto; }
        }
