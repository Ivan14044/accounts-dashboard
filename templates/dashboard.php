    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="uploadAccountsForm" method="POST" enctype="multipart/form-data" action="import_accounts.php" onsubmit="return false;">
           ...
           * отдельном партиале modals/add-account-modal.php, который не был
           * подключён ниоткуда, — правка той копии ничего не меняла для
           * пользователя. Партиал удалён (восстанавливается из истории git),
           * чтобы копия формы не расходилась с этой снова.
           *
