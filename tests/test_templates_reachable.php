 ...
 *
 * Сейчас пуст, и это правильное состояние. Проверка ниже следит, чтобы список
 * не протух: если файл из него удалят или подключат, тест потребует убрать
 * запись — иначе список со временем превратится в свалку отговорок.
 *
 * @var string[]
 */
$KNOWN_ORPHANS = array();
