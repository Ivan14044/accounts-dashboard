...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Список статусов (галочки, «Все»/«Очистить», поиск, закреплённые и
  // недавние) ведёт modules/status-filter.js — раньше его обработчики жили
  // здесь, и «Все»/«Очистить» меняли галочки, не применяя фильтр.
